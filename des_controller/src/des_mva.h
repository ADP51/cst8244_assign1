...
typedef enum {
	...
	LS_MSG = 1,
	RS_MSG = 2,
	LEFTDOOR_UNLOCK_MSG = 3,
	LEFTDOOR_OPEN_MSG = 4,
	LEFTDOOR_CLOSED_MSG = 5,
	LEFTDOOR_LOCKED_MSG = 6,
	WEIGHTSCAN_MSG = 7,
	RIGHTDOOR_UNLOCK_MSG = 8,
	RIGHTDOOR_OPEN_MSG = 9,
	RIGHTDOOR_CLOSED_MSG = 10,
	RIGHTDOOR_LOCKED_MSG = 11,
} Output_t;
